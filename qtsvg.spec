...
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.2/submodules/qtsvg-everywhere-src-5.14.2.tar.xz
...
%prep
%setup -q -n qtsvg-everywhere-src-5.14.2
cd %{_builddir}/qtsvg-everywhere-src-5.14.2
...
%install
export SOURCE_DATE_EPOCH=1586201664
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtsvg
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtsvg/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtsvg/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtsvg/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtsvg/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.GPLv3 %{buildroot}/usr/share/package-licenses/qtsvg/7d974f34cf5fd474f0fdf6ebc8d410ea5c8b72de
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtsvg/f45ee1c765646813b442ca58de72e20a64a7ddba
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.LGPLv21 %{buildroot}/usr/share/package-licenses/qtsvg/fe04fe44c5e1a407572a5cca79d39afd674bccf3
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/LICENSE.LGPLv3 %{buildroot}/usr/share/package-licenses/qtsvg/d8b489a3c3d500a6601181e3db39bec6124b86fc
cp %{_builddir}/qtsvg-everywhere-src-5.14.2/src/svg/XSVG_LICENSE.txt %{buildroot}/usr/share/package-licenses/qtsvg/9c7d86ef8571df996010cb73af37e99b031cd68e
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvgfont_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvggraphics_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvghandler_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvgnode_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvgstructure_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvgstyle_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qsvgtinydocument_p.h
/usr/include/qt5/QtSvg/5.14.2/QtSvg/private/qtsvgglobal_p.h
...
/usr/share/qt5/examples/svg/network/bearercloud/bearercloud.cpp
/usr/share/qt5/examples/svg/network/bearercloud/bearercloud.h
/usr/share/qt5/examples/svg/network/bearercloud/bearercloud.pro
/usr/share/qt5/examples/svg/network/bearercloud/bluetooth.svg
/usr/share/qt5/examples/svg/network/bearercloud/cell.svg
/usr/share/qt5/examples/svg/network/bearercloud/cloud.cpp
/usr/share/qt5/examples/svg/network/bearercloud/cloud.h
/usr/share/qt5/examples/svg/network/bearercloud/gprs.svg
/usr/share/qt5/examples/svg/network/bearercloud/icons.qrc
/usr/share/qt5/examples/svg/network/bearercloud/lan.svg
/usr/share/qt5/examples/svg/network/bearercloud/main.cpp
/usr/share/qt5/examples/svg/network/bearercloud/umts.svg
/usr/share/qt5/examples/svg/network/bearercloud/unknown.svg
/usr/share/qt5/examples/svg/network/bearercloud/wlan.svg
/usr/share/qt5/examples/svg/network/network.pro
...
/usr/lib64/libQt5Svg.so.5.14
/usr/lib64/libQt5Svg.so.5.14.2
