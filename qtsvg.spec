...
Version  : 5.13.1
Release  : 17
URL      : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtsvg-everywhere-src-5.13.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtsvg-everywhere-src-5.13.1.tar.xz
...
%prep
%setup -q -n qtsvg-everywhere-src-5.13.1
...
%install
export SOURCE_DATE_EPOCH=1568392869
rm -rf %{buildroot}
...
cp src/svg/XSVG_LICENSE.txt %{buildroot}/usr/share/package-licenses/qtsvg/src_svg_XSVG_LICENSE.txt
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvgfont_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvggraphics_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvghandler_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvgnode_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvgstructure_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvgstyle_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qsvgtinydocument_p.h
/usr/include/qt5/QtSvg/5.13.1/QtSvg/private/qtsvgglobal_p.h
...
/usr/share/package-licenses/qtsvg/src_svg_XSVG_LICENSE.txt
