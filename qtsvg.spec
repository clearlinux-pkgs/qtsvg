...
Version  : 5.14.1
Release  : 20
URL      : https://download.qt.io/official_releases/qt/5.14/5.14.1/submodules/qtsvg-everywhere-src-5.14.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.1/submodules/qtsvg-everywhere-src-5.14.1.tar.xz
...
%prep
%setup -q -n qtsvg-everywhere-src-5.14.1
cd %{_builddir}/qtsvg-everywhere-src-5.14.1
...
%install
export SOURCE_DATE_EPOCH=1580236544
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtsvg
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtsvg/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtsvg/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtsvg/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtsvg/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.GPLv3 %{buildroot}/usr/share/package-licenses/qtsvg/7d974f34cf5fd474f0fdf6ebc8d410ea5c8b72de
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtsvg/f45ee1c765646813b442ca58de72e20a64a7ddba
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.LGPLv21 %{buildroot}/usr/share/package-licenses/qtsvg/fe04fe44c5e1a407572a5cca79d39afd674bccf3
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/LICENSE.LGPLv3 %{buildroot}/usr/share/package-licenses/qtsvg/d8b489a3c3d500a6601181e3db39bec6124b86fc
cp %{_builddir}/qtsvg-everywhere-src-5.14.1/src/svg/XSVG_LICENSE.txt %{buildroot}/usr/share/package-licenses/qtsvg/9c7d86ef8571df996010cb73af37e99b031cd68e
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvgfont_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvggraphics_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvghandler_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvgnode_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvgstructure_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvgstyle_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qsvgtinydocument_p.h
/usr/include/qt5/QtSvg/5.14.1/QtSvg/private/qtsvgglobal_p.h
